...
import { Users, Plus, Edit2, Trash2, Search, RefreshCw, CheckCircle, XCircle, ShieldX, BarChart3 } from 'lucide-react';
        ...
        <div className="flex gap-2 mb-6">
          <button
            ...
            className={`flex items-center gap-2 px-5 py-2.5 rounded-lg font-medium transition-colors ${
              activeTab === 'users' ? 'bg-blue-600 text-white' : 'bg-white text-gray-600 hover:bg-gray-100 border border-gray-200'
            }`}
          >
            <Users size={18} />
            Användare
          ...
          <button
            ...
            className={`flex items-center gap-2 px-5 py-2.5 rounded-lg font-medium transition-colors ${
              activeTab === 'analytics' ? 'bg-blue-600 text-white' : 'bg-white text-gray-600 hover:bg-gray-100 border border-gray-200'
            }`}
          >
            <BarChart3 size={18} />
            Analys
